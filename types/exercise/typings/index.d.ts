...
export declare type TimerHighlightColorT = 'warn' | 'success' | 'error' | 'initial';
export interface IConstructorOptions {
    dataProviders: IProvidedDataApi;
    exerciseAttemptId: string;
    timeExpireHandlers?: HandlersMapT;
}
export declare type HandlersMapT<T = ((() => void)[]) | (() => void)> = {
    [key: string | number]: T;
};
...
export declare type DialogTypeT = 'success' | 'error' | 'warning';
export declare type DialogOptionsT = {
    type?: DialogTypeT;
    title?: string;
    message?: string;
    closeable?: boolean;
...
export declare type ValidationErrorT = {
...
export declare type ConfigurationT = {
    maps: string[];
    config: DictionaryT;
...
export declare type MapT = {
    id: string;
    img: string;
    map_translate_native: string;
    map_translate_exercise: string;
};
export declare type MapTranslateT = {
    id: string;
    map_id: string;
    name: string;
    description: string;
